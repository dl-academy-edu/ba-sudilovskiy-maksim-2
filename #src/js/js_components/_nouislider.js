  ...
  function H(t, b, o) {
    ...
    function D(t, e) {
      ...
      return (
        ...
        0 === e
          ? mt(n, b.cssClasses.handleLower)
          : e === b.handles - 1 && mt(n, b.cssClasses.handleUpper),
        r
      );
    }
    function M(t, e) {
    ...
    return (
      ...
      0 === b.ort
        ? mt(e, b.cssClasses.horizontal)
        : mt(e, b.cssClasses.vertical),
      mt(
        e,
      ...
      (a = {
        destroy: function () {
          for (var t in (G(bt.aria), G(bt.tooltips), b.cssClasses))
